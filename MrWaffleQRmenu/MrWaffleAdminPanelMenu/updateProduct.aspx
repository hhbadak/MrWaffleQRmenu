<%@ Page Title="" Language="C#" MasterPageFile="~/MrWaffleAdminPanelMenu/MrWaffleAdmin.Master" AutoEventWireup="true" CodeBehind="updateProduct.aspx.cs" Inherits="MrWaffleQRmenu.MrWaffleAdminPanelMenu.updateProduct" %>
        ...
        <div class="row">
            <div class="col-12 col-lg-6">
                ...
                <div class="card">
                    ...
                    <asp:TextBox ID="tb_name" runat="server" CssClass="form-control" Placeholder="ÜRÜN ADI"></asp:TextBox>
                    <br />
                    <label><b>Ürün Açıklamasını Giriniz</b></label>
                    <asp:TextBox ID="tb_description" runat="server" CssClass="form-control" TextMode="MultiLine" Placeholder="AÇIKLAMA"></asp:TextBox>
                    <br />
                    <label><b>Ürün Fiyatını Giriniz</b></label>
                    <asp:TextBox ID="tb_price" runat="server" CssClass="form-control" TextMode="Number" Placeholder="FİYAT"></asp:TextBox>
                    <br />
                    <label><b>Ürün Resmi</b></label>
                    <asp:Image ID="img_image" runat="server" Width="300"/>
                    <br />
