<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SignUp.aspx.cs" Inherits="MrWaffleQRmenu.MrWaffleAdminPanelMenu.SignUp" %>
...
<head runat="server">
    ...
    <link href="../MrWaffleAdminPanelMenu/css/app.css" rel="stylesheet" />
...
<body>
                    ...
                    <div class="col-sm-10 col-md-8 col-lg-6 mx-auto d-table h-100">
                        <div class="d-table-cell align-middle">
                            ...
                            <div class="text-center mt-4">
                                <img src="../MrWaffleAdminPanelMenu/img/LOGO.jpg" />
                            </div>
    ...
    <script src="../MrWaffleAdminPanelMenu/js/app.js"></script>
</body>
</html>
