...
{
    public partial class coldSandwich : System.Web.UI.Page
    {
        ...
        public void VeriDoldur()
        {
            ...
            //lv_listProduct.DataSource = dm.ProductListColdSandwich();
        ...
        protected void lv_listProduct_ItemCommand(object sender, ListViewCommandEventArgs e)
        {
            if (e.CommandName == "delete")
            {
                ...
                dm.DeleteProduct(id);
                Response.Redirect("~/YoneticiPaneli/coldSandwich.aspx");
            }
        }
    }
}